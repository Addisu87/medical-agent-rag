...
class Transcription(Base):
    ...
    terminology_validations = relationship("TerminologyValidation", back_populates="transcription")

class TerminologyValidation(Base):
    __tablename__ = "terminology_validations"
    ...
    validated_term = Column(String(200))
    is_medical = Column(Boolean, nullable=False)
    confidence = Column(Float)  # Validation confidence 0-1
